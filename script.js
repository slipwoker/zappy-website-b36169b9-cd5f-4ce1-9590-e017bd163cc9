document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      const label = (function () {
        ...
        return labelEl ? labelEl.textContent.replace('*', '').trim() : name;
      })();
  ...
  const animatedElements = document.querySelectorAll(
    '.animate-on-scroll, [data-animate], .feature-card, .pricing-card, .testimonial-card, .team-card, .service-card, .blog-card, .portfolio-item, .stat-item, .step-item'
  );
  ...
  if (animatedElements.length > 0) {
    animatedElements.forEach(function (el, index) {
      ...
      if (!el.hasAttribute(ANIMATION_DELAY_ATTR)) {
        ...
        el.style.transitionDelay = el.getAttribute(ANIMATION_DELAY_ATTR);
      }
    });
    ...
    if ('IntersectionObserver' in window) {
      ...
      function checkVisibility() {
        ...
        animatedElements.forEach(function (el) {
          ...
          if (rect.top <= windowHeight * (1 - ANIMATION_THRESHOLD)) {
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "AICON uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b36169b9-cd5f-4ce1-9590-e017bd163cc9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b36169b9-cd5f-4ce1-9590-e017bd163cc9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b36169b9-cd5f-4ce1-9590-e017bd163cc9';
